// XXcopter software
// ============
// Version XXcontrol_KR_v1.5b
// inspired by KKmulticopter
// based on assembly code by Rolf R Bakke
// Converted by Mike Barton
//
// Modified by Minsoo Kim
// Updated by Jean-Louis Naudin, tested on Quadcopter (QRO), Tricopter, 
// and with the QRO v7 (with the Wii Motion Plus sensors)
//
...
// Version History
// ==========
// _KR_v1.5b Tested on the QRO v7 with the Wii Motion Plus Sensors
//
...
#define ROLL_GAIN_MULTIPLIER 	5	// 3, WMP: 5
#define PITCH_GAIN_MULTIPLIER 	5	// 3, Twin: 4, WMP: 5
#define YAW_GAIN_MULTIPLIER 	6	// 3, WMP: 6
