...
//
// Copter Types*: TRI_COPTER, QUAD_COPTER, QUAD_X_COPTER and HEX_COPTER
// * only QUAD tested
//
// Additional Features:
...
#define EEPROM_DATA_START_POS 16		// allows moving (not really necessary)
...
#ifdef TRI_COPTER
	MotorOut3 -= RxInPitch;
	RxInRoll = (RxInPitch >> 1);	// cosine of 60
	MotorOut1 += RxInPitch;
	MotorOut2 += RxInPitch;
#endif
#ifdef QUAD_COPTER
